#ให้ทำโปรแกรมคำนวณหาสีที่ต้องให้ทาด้านนอกของกล่องสี่เหลี่ยมขนาดใหญ่ 1 กล่องของทุกด้านว่าต้องใช้สีกี่แกลอนโดยให้ผู้ใช้ป้อนความกว้าง ความยาว ความสูงของกล่อง (หน่อยเป็นเมตร) ทางแป้นพิมพ์ และแสดงผลจำนวนแกลอนที่ต้องใช้ทางหน้าจอ ดังนี้
